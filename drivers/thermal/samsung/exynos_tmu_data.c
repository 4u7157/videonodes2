...
static const struct exynos_tmu_registers exynos7570_tmu_registers = {
	...
	.tmu_ctrl = EXYNOS_TMU_REG_CONTROL,
	.tmu_ctrl1 = EXYNOS_TMU_REG_CONTROL1,
	/* This buf_vref_sel_reg, buf_slope_sel_reg member update EXYNOS7570 */
	.buf_vref_otp_reg = EXYNOS_TMU_REG_TRIMINFO,
	.buf_vref_otp_shift = EXYNOS_TMU_REF_VOLTAGE_OTP_SHIFT,
	.buf_vref_otp_mask = EXYNOS_TMU_REF_VOLTAGE_OTP_MASK_3BIT,
	.buf_slope_otp_reg = EXYNOS_TMU_REG_TRIMINFO1,
...
#define EXYNOS7570_TMU_DATA_CPUCL0 \
	.tmu_name = "CPUCL0",	\
	.temp_mask = TYPE_9BIT_MASK,	\
	.gain = 5, \
	.reference_voltage = 16, \
	...
	.second_point_trim = 85, \
	.default_temp_offset = 25, \
	.type = SOC_ARCH_EXYNOS7570, \
	.d_type = CLUSTER0, \
	.registers = &exynos7570_tmu_registers, \
	.features = (TMU_SUPPORT_EMULATION | TMU_SUPPORT_READY_STATUS | TMU_SUPPORT_EMUL_TIME), \
	.sensor_type = EXYNOS_TEM1455X,

#define EXYNOS7570_TMU_DATA_G3D \
	.tmu_name = "G3D",	\
	.temp_mask = TYPE_9BIT_MASK,	\
	.gain = 5, \
	.reference_voltage = 16, \
...
struct exynos_tmu_init_data exynos7570_default_tmu_data = {
	.tmu_data = {
		{ EXYNOS7570_TMU_DATA_CPUCL0 } ,
		{ EXYNOS7570_TMU_DATA_G3D } ,
	},
	.tmu_count = 2,
};
#endif
